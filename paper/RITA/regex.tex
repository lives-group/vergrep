...
\affiliation{*\textbf{Corresponding author}: rodrigo.ribeiro\text{\tt \char64{}\char64{}}ufop.edu.br} % Corresponding author
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\V{\char95 ::\char95 }\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;\to \;\V{A}\;\to \;\D{Vec}\;\V{A}\;\V{n}\;\to \;\D{Vec}\;\V{A}\;(\C{suc}\;\V{n}){}\<[E]%
\ColumnHook
...
used in our formalization use this type. The type \ensuremath{\F{\neg}\;\V{P}} is an
...
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\C{Odd}\;{}\<[9]%
\>[9]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\;\mathbin{:}\;\D{\mathbb{N}}\mskip1.5mu\}\;\to \;\D{Parity}\;(\C{suc}\;(\V{n}\;\F{+}\;\V{n})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{\_\bullet\_\Rightarrow\_}\;\mathbin{:}\;\V{xs}\;\D{\in\llbracket}\;\V{l}\;\D{\rrbracket}\;{}\<[29]%
\>[29]{}\to \;\V{ys}\;\D{\in\llbracket}\;\V{r}\;\D{\rrbracket}\;{}\<[47]%
\>[47]{}\to \;\V{zs}\;\D{\equiv}\;\V{xs}\;\F{++}\;\V{ys}\;\to \;\V{zs}\;\D{\in\llbracket}\;\V{l}\;\C{\bullet}\;\V{r}\;\D{\rrbracket}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{\_\star}\;\mathbin{:}\;\V{xs}\;\D{\in\llbracket}\;\C{\lambda}\;\C{+}\;(\V{e}\;\C{\bullet}\;\V{e}\;\C{\star})\;\D{\rrbracket}\;\to \;\V{xs}\;\D{\in\llbracket}\;\V{e}\;\C{\star}\;\D{\rrbracket}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\C{\_\bullet\_\Rightarrow\_}} can be used to build a parse tree
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{+invert}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{xs}\;\V{l}\;\V{r}\mskip1.5mu\}\;\to \;\V{xs}\;\D{\in\llbracket}\;\V{l}\;\C{+}\;\V{r}\;\D{\rrbracket}\;\to \;\V{xs}\;\D{\in\llbracket}\;\V{l}\;\D{\rrbracket}\;\D{\lor}\;\V{xs}\;\D{\in\llbracket}\;\V{r}\;\D{\rrbracket}{}\<[E]%
\\
\>[B]{}\F{+invert}\;(\V{r}\;\C{+L}\;\V{pr})\;\mathrel{=}\;\C{inj_1}\;\V{pr}{}\<[E]%
\\
\>[B]{}\F{+invert}\;(\V{l}\;\C{+R}\;\V{pr})\;\mathrel{=}\;\C{inj_2}\;\V{pr}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
(function \ensuremath{\F{\#-Invert}}) specifies that 
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{\#-Invert}\;\mathbin{:}\;{}\<[15]%
\>[15]{}\V{x}\;\C{::}\;\V{xs}\;\D{\in\llbracket}\;\C{\$}\;\V{y}\;\D{\rrbracket}\;\to \;\V{x}\;\D{\equiv}\;\V{y}\;\D{\times}\;\V{xs}\;\D{\equiv}\;\C{\lbrack\:\rbrack}{}\<[E]%
\\
\>[3]{}\F{\#-Invert}\;(\C{\$}\;\V{c})\;\mathrel{=}\;\C{refl}\;\red{,}\,\;\C{refl}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{\nu[\_]}\;\mathbin{:}\;\D{\forall}\;(\V{e}\;\mathbin{:}\;\D{Regex})\;\to \;\D{Dec}\;(\C{\lbrack\:\rbrack}\;\D{\in\llbracket}\;\V{e}\;\D{\rrbracket}){}\<[E]%
\\
...
\\
\>[3]{}\F{\nu[ }\;\V{e}\;\C{\bullet}\;\V{e'}\;\F{]}\;\mathkw{with}\;\F{\nu[ }\;\V{e}\;\F{]}\;\mid \;\F{\nu[ }\;\V{e'}\;\F{]}{}\<[E]%
\\
\>[3]{}\F{\nu[ }\;\V{e}\;\C{\bullet}\;\V{e'}\;\F{]}\;\mid \;\C{yes}\;\V{pr}\;\mid \;(\C{yes}\;\V{pr1})\;\mathrel{=}\;\C{yes}\;(\V{pr}\;\V{>}\;\V{pr1}\;\C{\Rightarrow}\;\C{refl}){}\<[E]%
\\
\>[3]{}\F{\nu[ }\;\V{e}\;\C{\bullet}\;\V{e'}\;\F{]}\;\mid \;\C{yes}\;\V{pr}\;\mid \;(\C{no}\;\V{pr1})\;\mathrel{=}\;\C{no}\;(\V{pr1}\;\F{\circ}\;\F{\pi_2}\;\F{\circ}\;\F{\bullet -invert}){}\<[E]%
\\
\>[3]{}\F{\nu[ }\;\V{e}\;\C{\bullet}\;\V{e'}\;\F{]}\;\mid \;\C{no}\;\V{pr}\;\mid \;\V{pr1}\;\mathrel{=}\;\C{no}\;(\V{pr}\;\F{\circ}\;\F{\pi_1}\;\F{\circ}\;\F{\bullet -invert}){}\<[E]%
\\
...
\\
\>[3]{}\F{\nu[ }\;\V{e}\;\C{+}\;\V{e'}\;\F{]}\;\mid \;\C{no}\;\V{pr}\;\mid \;(\C{no}\;\V{pr1})\;\mathrel{=}\;\C{no}\;([\mskip1.5mu \;\V{pr}\;\red{,}\,\;\V{pr1}\;\mskip1.5mu]\;\F{\circ}\;\V{+-invert}){}\<[E]%
\\
\>[3]{}\F{\nu[ }\;\V{e}\;\V{*}\;\F{]}\;\mathrel{=}\;\C{yes}\;((\V{e}\;\C{\bullet}\;\V{e}\;\C{\star}\;\C{+L}\;\C{\lambda})\;\C{\star}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{\_\oplus\_}\;\mathbin{:}\;(\V{e}\;\V{e'}\;\mathbin{:}\;\D{Regex})\;\to \;\D{Regex}{}\<[E]%
\\
\>[3]{}\C{\emptyset}\;\F{\oplus}\;\V{e'}\;\mathrel{=}\;\V{e'}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{\oplus}\;\C{\emptyset}\;{}\<[13]%
\>[13]{}\mathrel{=}\;\V{e}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{\oplus}\;\V{e'}\;\mathrel{=}\;\V{e}\;\C{+}\;\V{e'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{\_\otimes\_}\;\mathbin{:}\;(\V{e}\;\V{e'}\;\mathbin{:}\;\D{Regex})\;\to \;\D{Regex}{}\<[E]%
\\
\>[3]{}\C{\emptyset}\;\F{\otimes\}\;\V{e'}\;\mathrel{=}\;\C{\emptyset}{}\<[E]%
\\
\>[3]{}\C{\lambda}\;\F{\otimes\}\;\V{e'}\;\mathrel{=}\;\V{e'}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{\otimes\}\;\C{\emptyset}\;\mathrel{=}\;\C{\emptyset}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{\otimes\}\;\C{\lambda}\;\mathrel{=}\;\V{e}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{\otimes\}\;\V{e'}\;\mathrel{=}\;\V{e}\;\F{\circ}\;\V{e'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\V{\char95 :⋆}\;\mathbin{:}\;\D{Regex}\;\to \;\D{Regex}{}\<[E]%
\\
\>[3]{}\C{\emptyset}\;\F{\star\star}\;\mathrel{=}\;\C{\lambda}{}\<[E]%
\\
\>[3]{}\C{\lambda}\;\F{\star\star}\;\mathrel{=}\;\C{\lambda}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{\star\star}\;\mathrel{=}\;\V{e}\;\C{\star}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\F{\oplus}\;\V{e'}\;\D{\rrbracket}} holds if and only if, \ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\C{+}\;\V{e'}\;\D{\rrbracket}} also holds.
\end{Lemma}
\begin{proof}
  \begin{itemize}
      \item[]
  ...
  \ensuremath{\C{\emptyset}}. If \ensuremath{\V{e}\;\mathrel{=}\;\C{\emptyset}}, then \ensuremath{\C{\emptyset}\;\F{\oplus}\;\V{e'}\;\mathrel{=}\;\V{e'}} and
  the desired result follows. The same reasoning applies for \ensuremath{\V{e'=}\;\C{\emptyset}}.
...
For all REs \ensuremath{\V{e}}, \ensuremath{\V{e'}} and all strings \ensuremath{\V{xs}},
\ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\F{\otimes\}\;\V{e'}\;\D{\rrbracket}} holds if and only if, \ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\F{\circ}\;\V{e'}\;\D{\rrbracket}}
also holds.
\end{Lemma}
\begin{proof}
    \item[]
  ...
  proof term \ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\F{\otimes\}\;\V{e'}\;\D{\rrbracket}}, using list concatenation
  properties.
  \item[($\leftarrow$)]:
  By case analysis on the structure of \ensuremath{\V{e}}, \ensuremath{\V{e'}}. The
  interesting cases are when \ensuremath{\V{e}} or \ensuremath{\V{e'}} are equal to
...
\ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\F{\star\star}\;\D{\rrbracket}} holds if and only if, \ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\C{\star}\;\D{\rrbracket}} also holds.
\end{Lemma}
\begin{proof}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{\partial[\_,\_]}\;\mathbin{:}\;\D{Regex}\;\to \;\D{Char}\;\to \;\D{Regex}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\C{\emptyset}\;\red{,}\,\;\V{c}\;\F{]}\;\mathrel{=}\;\C{\emptyset}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\C{\lambda}\;\red{,}\,\;\V{c}\;\F{]}\;\mathrel{=}\;\C{\emptyset}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\C{\$}\;\V{c}\;\red{,}\,\;\V{c'}\;\F{]}\;\mathkw{with}\;\V{c}\;\F{\overset{?}{=}}\;\V{c'}{}\<[E]%
\\
\>[3]{}\V{...|}\;\C{yes}\;\C{refl}\;\mathrel{=}\;\C{\lambda}{}\<[E]%
\\
\>[3]{}\V{...|}\;\C{no}\;\V{prf}\;\mathrel{=}\;\C{\emptyset}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\V{e}\;\F{\circ}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}\;\mathkw{with}\;\F{\nu[ }\;\V{e}\;\F{]}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\V{e}\;\F{\circ}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}\;\mid \;\C{yes}\;\V{pr}\;\mathrel{=}\;(\F{\partial[}\;\V{e}\;\red{,}\,\;\V{c}\;\F{]}\;\F{\otimes\}\;\V{e'})\;\F{\oplus}\;\F{\partial[}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\V{e}\;\F{\circ}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}\;\mid \;\C{no}\;\V{pr}\;\mathrel{=}\;\F{\partial[}\;\V{e}\;\red{,}\,\;\V{c}\;\F{]}\;\F{\otimes\}\;\V{e'}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\V{e}\;\C{+}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}\;\mathrel{=}\;\F{\partial[}\;\V{e}\;\red{,}\,\;\V{c}\;\F{]}\;\F{\oplus}\;\F{\partial[}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}{}\<[E]%
\\
\>[3]{}\F{\partial[}\;\V{e}\;\C{\star}\;\red{,}\,\;\V{c}\;\F{]}\;\mathrel{=}\;\F{\partial[}\;\V{e}\;\red{,}\,\;\V{c}\;\F{]}\;\F{\otimes\}\;(\V{e}\;\V{`⋆}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
From this definition we prove the following important properties of
the derivative operation. Soundness of \ensuremath{\F{\partial[\_,\_]}} ensures that if a
string \ensuremath{\V{xs}} is in the language of \ensuremath{\F{\partial[}\;\V{e}\;\red{,}\,\;\V{x}\;\F{]}}, then
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{\_\odot\_}\;\mathbin{:}\;\D{Regexes}\;\to \;\D{Regex}\;\to \;\D{Regexes}{}\<[E]%
\\
\>[3]{}\C{\lbrack\:\rbrack}\;\F{\odot}\;\V{e}\;\mathrel{=}\;\C{\lbrack\:\rbrack}{}\<[E]%
\\
\>[3]{}(\V{e'}\;\C{::}\;\V{es'})\;\F{\odot}\;\V{e}\;\mathrel{=}\;(\V{e'}\;\F{\circ}\;\V{e})\;\C{::}\;(\V{es'}\;\F{\odot}\;\V{e}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{\nabla[\_,\_]}\;\mathbin{:}\;\D{Regex}\;\to \;\D{Char}\;\to \;\D{Regexes}{}\<[E]%
\\
...
\\
\>[3]{}\F{\nabla[}\;\V{e}\;\F{\circ}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}\;\mathkw{with}\;\F{\nu[ }\;\V{e}\;\F{]}{}\<[E]%
\\
\>[3]{}\F{\nabla[}\;\V{e}\;\F{\circ}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}\;\mid \;\C{yes}\;\V{p}\;\mathrel{=}\;(\V{e'}\;\F{\odot}\;\F{\nabla[}\;\V{e}\;\red{,}\,\;\V{c}\;\F{]})\;\F{++}\;\F{\nabla[}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}{}\<[E]%
\\
\>[3]{}\F{\nabla[}\;\V{e}\;\F{\circ}\;\V{e'}\;\red{,}\,\;\V{c}\;\F{]}\;\mid \;\C{no}\;\V{p}\;\mathrel{=}\;\V{e'}\;\F{\odot}\;\F{\nabla[}\;\V{e}\;\red{,}\,\;\V{c}\;\F{]}{}\<[E]%
\\
...
strings \ensuremath{\V{ys}} and \ensuremath{\V{zs}} such that \ensuremath{\V{xs}\;\D{\equiv}\;\V{ys}\;\F{++}\;\V{zs}} and \ensuremath{\V{ys}\;\D{\in\llbracket}\;\V{e}\;\D{\rrbracket}}.
Definition of \ensuremath{\D{IsPrefix}} datatype encodes this concept. Datatype
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{Prefix}\;\mathbin{:}\;{}\<[15]%
\>[15]{}\V{xs}\;\D{\equiv}\;\V{ys}\;\F{++}\;\V{zs}\;\to \;\V{ys}\;\D{\in\llbracket}\;\V{e}\;\D{\rrbracket}\;\to \;\D{IsPrefix}\;\V{xs}\;\V{e}{}\<[E]%
\\[\blanklineskip]%
...
prefix. Otherwise, it verifies, for each symbol \ensuremath{\V{x}}, whether RE \ensuremath{\F{\partial[}\;\V{e}\;\red{,}\,\;\V{x}\;\F{]}}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{IsPrefixDec}\;\mathbin{:}\;\D{\forall}\;(\V{xs}\;\mathbin{:}\;\D{List}\;\D{Char})\;(\V{e}\;\mathbin{:}\;\D{Regex})\;\to \;\D{Dec}\;(\D{IsPrefix}\;\V{xs}\;\V{e}){}\<[E]%
\\
...
\\
\>[3]{}\F{IsPrefixDec}\;\C{\lbrack\:\rbrack}\;\V{e}\;\mid \;\C{no}\;\V{p}\;\mathrel{=}\;\C{no}\;(\F{\neg IsPrefix}\;\V{p}){}\<[E]%
\\
...
\\
\>[3]{}\F{IsPrefixDec}\;(\V{x}\;\C{::}\;\V{xs})\;\V{e}\;\mid \;\C{no}\;\V{p}\;\mathkw{with}\;\F{IsPrefixDec}\;\V{xs}\;(\F{\partial[}\;\V{e}\;\red{,}\,\;\V{x}\;\mskip1.5mu]){}\<[E]%
\\
\>[3]{}\F{IsPrefixDec}\;(\V{x}\;\C{::}\;\V{xs})\;\V{e}\;\mid \;\C{no}\;\V{p}\;\mid \;(\C{yes}\;(\C{Prefix}\;\V{ys}\;\V{zs}\;\V{eq}\;\V{wit}))\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathrel{=}\;\C{yes}\;(\C{Prefix}\;(\V{x}\;\C{::}\;\V{ys})\;\V{zs}\;(\F{cong}\;(\V{\char95 ::\char95 }\;\V{x})\;\V{eq})\;(\F{\partial-sound}\;\anonymous \;\anonymous \;\anonymous \;\V{wit})){}\<[E]%
\\
\>[3]{}\F{IsPrefixDec}\;(\V{x}\;\C{::}\;\V{xs})\;\V{e}\;\mid \;\C{no}\;\V{pn}\;\mid \;(\C{no}\;\V{p})\;\mathrel{=}\;\C{no}\;(\F{\neg IsPrefix-::}\;\V{pn}\;\V{p}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\F{IsSubstringDec}\;\mathbin{:}\;\D{\forall}\;(\V{xs}\;\mathbin{:}\;\D{List}\;\D{Char})\;(\V{e}\;\mathbin{:}\;\D{Regex})\;\to \;\D{Dec}\;(\D{IsSubstring}\;\V{xs}\;\V{e}){}\<[E]%
\\
...
\\
\>[3]{}\F{IsSubstringDec}\;\C{\lbrack\:\rbrack}\;\V{e}\;\mid \;\C{no}\;\V{p}\;\mathrel{=}\;\C{no}\;(\F{\neg IsSubstring}\;(\F{\neg IsPrefix}\;\V{p})){}\<[E]%
\\
...
\\
\>[3]{}\F{IsSubstringDec}\;(\V{x}\;\C{::}\;\V{xs})\;\V{e}\;\mid \;\C{no}\;\V{p1}\;\mid \;(\C{no}\;\V{p})\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathrel{=}\;\C{no}\;(\F{\neg IsSubstring-::}\;\V{p1}\;\V{p}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
